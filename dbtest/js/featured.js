 ...
 * Renders 2-3 "showroom" cars into #featured-grid, chosen from the same
 * public RTO feed the inventory page uses (data/vehicles-rto.json).
 *
 * WHICH cars appear is driven by the "featured" block in that JSON, which the
 * owner controls from the admin dashboard ("Featured Vehicles" card). Shape:
 *   "featured": {
 *     "enabled": true,
 ...
 */
(function () {
  var INVENTORY_PAGE = "Orlando2.html";
